...
INSERT INTO `car_rental`.`invoice` (`invoice_id`, `address_line1`, `address_line2`, `address_line3`, `business_compid`, `business_name`, `contract_number`, `expense_amount`, `invoice_number`, `service_description`, `total_count`) VALUES ('1', 'Laisvės al. 37', 'Kaunas', 'LT-10849', '123456789', 'Žvaigždūnė Tvarijonaitė', 'ĄąČčĘęĖėĮįŠšŲųŪūŽž /55/CAR-21-Nr.01/2021', 198.37, 'CAR-21 NR.1', 'Car invoicing', '1');
